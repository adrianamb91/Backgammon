...
class Piece(object):
    ...
    def draw_shadow(self, x, y, color, start_width, end_width):
        ...
        for i in range(levels):
            shadow_value = (conf.PIECE_SHADOW_STEP * i) ** conf.PIECE_SHADOW_POWER
    ...
    def draw(self, x, y, width, init = False):
        piece_width = []
        piece_shadow_thickness = width * conf.PIECE_SHADOW_THICKNESS
        piece_width.append(width - piece_shadow_thickness)
        piece_shadow = width
